...
abstract class TransactionPayloadRequest extends FormRequest
{
    ...
    private function transactionRules(): array
    {
        return [
            ...
            'transaction.status' => ['nullable', 'string', Rule::in(\App\Enums\TransactionStatus::values())],
        ];
    }
    ...
    private function generalInfoCustomerRules(): array
    {
        return [
            ...
            'general_info_customer.prices_customer_rate' => ['nullable', 'string', 'max:255'],
    ...
    private function generalInfoPackerRules(): array
    {
        return [
            ...
            'general_info_packer.prices_packer_rate' => ['nullable', 'string', 'max:255'],
    ...
    private function cashFlowRules(): array
    {
        return [
            ...
            'cash_flow_packer.invoice_number' => ['nullable', 'string', 'max:255'],
